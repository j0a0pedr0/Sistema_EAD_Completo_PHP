...
<div class="menu">
    <div class="menu-wraper">
        ...
        <div class="items-menu">
            ...
            <h2>Gestão de EAD</h2>
            <a <?php selecionadoMenu('cadastrar-aluno'); ?> href="<?php echo INCLUDE_PATH_PAINEL; ?>cadastrar-aluno">Cadastrar Aluno Novo</a>
            <a <?php selecionadoMenu('cadastrar-modulo'); ?> href="<?php echo INCLUDE_PATH_PAINEL; ?>cadastrar-modulo">Cadastrar Módulo Novo</a>
            <a <?php selecionadoMenu('cadastrar-aula'); ?> href="<?php echo INCLUDE_PATH_PAINEL; ?>cadastrar-aula">Cadastrar Aula Nova</a>
...
<script src="<?php echo INCLUDE_PATH_PAINEL; ?>js/maskMoney.js"></script>
<?php } ?>
